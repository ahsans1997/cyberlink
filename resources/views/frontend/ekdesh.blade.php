...
<body>
    ...
    <div style="padding-top: 100px;" id="services" class="services section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                        <h4>Affordable <em> &amp;</em> Flexible Pricing</h4>
                        <img src="assets/images/heading-line-dec.png" alt="">
                        <h4 style="color:#1bbd36;">Ek Desh Ek Rate</h4>
                ...
                @foreach ($packages as $package)
                    <div class="col-lg-3 mt-2">
                        <div class="service-item third-service">
                            <div class="icon"></div>
                            <h4 style="font-size:40px;font-weight: bold;font-style: !important;"> {{ $package->speed }} Mbps </h4>
                            <h4> <span style="font-size: 30px;font-style: italic;text-align:right;">{{ $package->price }} </span> Tk/Month
                                (Excluding Vat)
                            </h4>
                            <p class="color:black; ">Bufferless Youtube</p>
                            <p>5 Mbps (Including Facebook)</p>
                            <p>Private IP</p>
                            <p>1:8 Shared Bandwidth</p>
                            <p>24/7 Customer Support</p>
                            <div class="border-button">
                                <button type="button" data-id="{{ $package->id }}" class="purchaseButton">Purchase Now</button>
                            </div>
                        </div>
